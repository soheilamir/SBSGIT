...
namespace SBSWebProject.AutoMappingObject.ModelToEntity
{
    public class AirlineMapper : IMappingObject<Web.Api.Models.Airlines, Airlines>
    {
        ...
        public Airlines Map(Web.Api.Models.Airlines objectToMap, Airlines refObj)
        {
            if (objectToMap == null) return null;
            var countryMapper = new CountryMapper();
            var flightConditionMapper = new FlightConditionMapper();
            ...
            refObj.FlightStateCode = objectToMap.FlightStateCode;
            refObj.IacoCode = objectToMap.IacoCode;
            refObj.IataCode = objectToMap.IataCode;
            refObj.Name = objectToMap.Name;
            refObj.Type = objectToMap.Type;
            refObj.Include = objectToMap.Include;
