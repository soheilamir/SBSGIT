...
'use strict'
angular.module('flightNumberServicesModule').controller('flightNumberServicesCtrl', ['$scope', '$rootScope', 'i18nService', '$http', '$interval', '$q', 'ngProgressFactory', 'CMSServicesBaseInfoFactory', function ($scope, $rootScope, i18nService, $http, $interval, $q, ngProgressFactory, CMSServicesBaseInfoFactory) {
