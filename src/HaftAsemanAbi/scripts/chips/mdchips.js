angular.module('mdChips', [])
	...
	.directive('mdChips', ['$compile', '$timeout', '$document', 'chipsService', 'airlineManagerFactory', function ($compile, $timeout, $document, chipsService, airlineManagerFactory) {
	    return {
	        restrict: 'E',
	        replace: true,
	        ...
	        link: function (scope, element, attrs) {
	            scope.collection = airlineManagerFactory.objAirline.lstAirline;
	            scope.ytop = '10px';
