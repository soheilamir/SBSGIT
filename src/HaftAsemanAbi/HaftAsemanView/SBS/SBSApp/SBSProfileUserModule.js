...
'use strict'
var SBSProfileUserApp = angular.module("SBSProfileUserApp", [
    'ngRoute',
    'ngMaterial',
    'angucomplete-alt',
    'SBSLinkUserCompany',
...
SBSProfileUserApp.config(function ($httpProvider) {
    $httpProvider.interceptors.push('authInterceptorService');
});
SBSProfileUserApp.run(['$rootScope', '$http', 'config', 'AuthManager', '$window', function ($rootScope, $http, config, AuthManager, $window) {
...
function fetchData() {
    ...
    $http({
        ...
        SBSProfileUserApp.constant("config", configuration);
    });
    return $http({
        method: configuration.Get,
...
function bootstrapProfileApplication() {
    angular.element(document).ready(function () {
        angular.bootstrap(document, ["SBSProfileUserApp"]);
    });
}