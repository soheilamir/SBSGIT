...
'use strict'
angular.module('profileFrameworkModule').controller('profileFrameworkCtrl', ['$scope', '$rootScope', '$location', 'HotelPackageManagerFactory', 'flightPackageManagerFactory', 'orderManagerServices', 'orderServicesModel', function ($scope, $rootScope, $location, HotelPackageManagerFactory, flightPackageManagerFactory, orderManagerServices, orderServicesModel) {
    ...
    $scope.menuHomeItemList = {
        ...
        { name: "اطلاعات کلی", title: "اطلاعات کلی", href: '#/sbs/user-profile/profile-page' },
        { name: "شارژ حساب کاربری", title: "شارژ حساب کاربری", href: '#/sbs/user-profile/users/charge-account' },
        ],
        n: "h",
    };
