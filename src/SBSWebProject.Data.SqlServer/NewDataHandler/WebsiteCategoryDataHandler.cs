...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class WebsiteCategoryDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.WebsiteCategory>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.WebsiteCategory> de;

        public WebsiteCategoryDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.WebsiteCategory>(this.sessionFactory);
        }
