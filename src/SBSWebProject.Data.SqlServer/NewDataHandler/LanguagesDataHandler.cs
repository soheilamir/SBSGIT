...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class LanguagesDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.Languages>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.Languages> de;

        public LanguagesDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.Languages>(this.sessionFactory);
        }
