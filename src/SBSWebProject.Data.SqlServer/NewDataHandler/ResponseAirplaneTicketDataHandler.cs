...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class ResponseAirplaneTicketDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.ResponseAirplaneTicket>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.ResponseAirplaneTicket> de;

        public ResponseAirplaneTicketDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.ResponseAirplaneTicket>(this.sessionFactory);
        }
