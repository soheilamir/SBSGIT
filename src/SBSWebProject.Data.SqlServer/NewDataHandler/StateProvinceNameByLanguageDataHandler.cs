...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class StateProvinceNameByLanguageDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.StateProvinceNameByLanguage>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.StateProvinceNameByLanguage> de;

        public StateProvinceNameByLanguageDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.StateProvinceNameByLanguage>(this.sessionFactory);
        }
