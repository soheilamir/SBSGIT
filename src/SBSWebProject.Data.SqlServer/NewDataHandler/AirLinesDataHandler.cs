...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class AirLinesDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.Airlines>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.Airlines> de;

        public AirLinesDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.Airlines>(this.sessionFactory);
        }
