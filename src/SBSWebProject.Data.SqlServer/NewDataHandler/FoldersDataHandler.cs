...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class FoldersDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.Folders>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.Folders> de;

        public FoldersDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.Folders>(this.sessionFactory);
        }
