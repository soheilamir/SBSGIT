...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class SbsBranchTeamDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.SbsBranchTeam>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.SbsBranchTeam> de;

        public SbsBranchTeamDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.SbsBranchTeam>(this.sessionFactory);
        }
