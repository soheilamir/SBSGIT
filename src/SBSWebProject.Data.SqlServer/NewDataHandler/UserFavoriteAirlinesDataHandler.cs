...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class UserFavoriteAirlinesDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.UserFavoriteAirlines>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.UserFavoriteAirlines> de;

        public UserFavoriteAirlinesDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.UserFavoriteAirlines>(this.sessionFactory);
        }
