...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class SbsBranchImagesDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.SbsBranchImages>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.SbsBranchImages> de;

        public SbsBranchImagesDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.SbsBranchImages>(this.sessionFactory);
        }
