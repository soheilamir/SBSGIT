...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class AirlineClassesDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.AirlineClasses>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.AirlineClasses> de;

        public AirlineClassesDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.AirlineClasses>(this.sessionFactory);
        }
