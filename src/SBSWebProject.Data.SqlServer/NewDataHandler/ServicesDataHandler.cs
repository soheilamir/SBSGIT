...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class ServicesDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.Services>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.Services> de;

        public ServicesDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.Services>(this.sessionFactory);
        }
