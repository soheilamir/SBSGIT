...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class UsersDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.Users>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.Users> de;

        public UsersDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.Users>(this.sessionFactory);
        }
