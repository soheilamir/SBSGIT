...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class SbsTagsDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.SbsTags>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.SbsTags> de;

        public SbsTagsDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.SbsTags>(this.sessionFactory);
        }
