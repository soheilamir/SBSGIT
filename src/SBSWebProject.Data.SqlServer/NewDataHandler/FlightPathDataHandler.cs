...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class FlightPathDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.FlightPath>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.FlightPath> de;

        public FlightPathDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.FlightPath>(this.sessionFactory);
        }
