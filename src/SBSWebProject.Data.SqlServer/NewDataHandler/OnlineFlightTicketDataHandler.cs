...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class OnlineFlightTicketDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.OnlineFlightTicket>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.OnlineFlightTicket> de;

        public OnlineFlightTicketDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.OnlineFlightTicket>(this.sessionFactory);
        }
