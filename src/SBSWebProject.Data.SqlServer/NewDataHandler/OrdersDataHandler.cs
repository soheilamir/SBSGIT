...
namespace SBSWebProject.Data.SqlServer.NewDataHandler
{
	public class OrdersDataHandler : IBasicDataHandler<SBSWebProject.Data.Entities.Orders>
	{
        ...
        DomainEntity<SBSWebProject.Data.Entities.Orders> de;

        public OrdersDataHandler(ISessionFactory sessionFactory)
        {

            this.sessionFactory = sessionFactory;
            this.de = new DomainEntity<SBSWebProject.Data.Entities.Orders>(this.sessionFactory);
        }
