...
{
    public class SbsTagsDomainEntity : IDomainEntity<SBSWebProject.Data.Entities.SbsTags>
    {
        private Type persitentType = typeof(SbsTags);

        private readonly ISession _session;
        public SbsTagsDomainEntity(ISession session)
        {
            _session = session;
        }
        ...
        public void Delete(SbsTags entity)
        {
            GetSession().Delete(entity);
        }

        public System.Collections.IList GetByExample(SbsTags exampleInstance, string[] propertiesToExclude)
        {
        ...
        public System.Collections.IList GetByExampleExactValue(SbsTags exampleInstance, string[] propertiesToExclude)
        {
            ISession session = GetSession();
            ICriteria criteria = session.CreateCriteria(persitentType);
            Example example = Example.Create(exampleInstance);
        ...
        public SbsTags GetEntityByID(long id)
        {
            ISession session = this.GetSession();
            return (SbsTags)session.Load(persitentType, id);
        }

        public System.Collections.IList GetEntityS()
        {
            ISession session = this.GetSession();
            return session.CreateCriteria<SbsTags>().List();
        ...
        public void Save(SbsTags entity)
        {
        ...
        public void Update(SbsTags entity)
        {
            ISession session = GetSession();
        ...
        {
            ISession session = this.GetSession();
            return session.CreateCriteria<SbsTags>().Add(Restrictions.Eq("State", state)).List();
        }

        public void DeleteByState(SbsTags entity)
        {
            entity.State = 1;
            ISession session = GetSession();
            var tx = session.BeginTransaction();
